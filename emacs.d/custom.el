(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (popwin racer go-mode yaml-mode evil-magit evil lua-mode rust-mode inf-ruby flycheck helm-projectile less-css-mode markdown-mode exec-path-from-shell helm solidity-mode magit coffee-mode rspec-mode ace-window try use-package js2-mode)))
